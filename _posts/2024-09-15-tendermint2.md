...
下面进入正题，本篇文章是在阅读了 [Tendermint 共识协议部分的源代码](https://github.com/tendermint/tendermint/blob/main/consensus/state.go)之后产生的新的理解。此外，为进一步理解 Tendermint 建议阅读[这篇论文](https://tendermint.com/static/docs/tendermint.pdf)，涉及 Tendermint Core 共识部分的具体实现，而原始的 [Tendermint 论文](https://arxiv.org/abs/1807.04938)更多是理论上的。
